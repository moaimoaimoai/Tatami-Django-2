...
class AffiliateLinks(models.Model):
    ...
    img = models.ImageField(blank=True, null=True, upload_to=upload_affiliate_links_path)
    created_on = models.DateTimeField(auto_now_add=True)
...
class MonoPage(models.Model):
    ...
    created_on = models.DateTimeField(auto_now_add=True)
    img = models.ImageField(blank=True, null=True, upload_to=upload_mono_page_path)
    followed = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='followed',blank=True)
    attribute = models.ManyToManyField(PageAttribute, related_name="pageattributeid", blank=True)
    affiliateId = models.ForeignKey(AffiliateLinks, blank=True,null=True, related_name='affiliateId',on_delete=models.CASCADE)
...
class MonoPost(models.Model):
    ...
    created_on = models.DateTimeField(auto_now_add=True)
    img = models.ImageField(blank=True, null=True, upload_to=upload_mono_post_path)
    liked = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='liked',blank=True)
    repost = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='repost',blank=True)
...
class UserIntPage(models.Model):
    ...
    intPageId = models.ForeignKey(MonoPage, blank=True,null=True, related_name='intPageId',on_delete=models.CASCADE)
    created_on = models.DateTimeField(auto_now_add=True)
...
class UserIntPost(models.Model):
    ...
    intPostId = models.ForeignKey(MonoPost, blank=True, null=True,related_name='intPostId',on_delete=models.CASCADE)
    created_on = models.DateTimeField(auto_now_add=True)
...
class UserIntComment(models.Model):
    ...
    intCommentId = models.ForeignKey(MonoComment, blank=True,null=True,related_name='intCommentId',on_delete=models.CASCADE)
    created_on = models.DateTimeField(auto_now_add=True)
...
class UserIntUser(models.Model):
    ...
    intUserId = models.ForeignKey(settings.AUTH_USER_MODEL,null=True, related_name='intUserId',blank=True,on_delete=models.CASCADE)
    created_on = models.DateTimeField(auto_now_add=True)
...
class UserIntAttribute(models.Model):
    ...
    intAttributeId=models.ForeignKey(PageAttribute, blank=True, null=True, related_name="intAttributeId", on_delete=models.CASCADE)
    created_on = models.DateTimeField(auto_now_add=True)
...
class FollowingPage(models.Model):
    ...
    pageId = models.ForeignKey(MonoPage, blank=True,null=True, related_name='followPageId',on_delete=models.CASCADE)
    created_on = models.DateTimeField(auto_now_add=True)
